        ...
        ((Button)findViewById(R.id.ComputeBtn)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (aEditText.getText().toString().equals("")) {
                    Toast errorToast = Toast.makeText(MainActivity.this, "Error, please write the value of a parameter", Toast.LENGTH_SHORT);
                    errorToast.show();
                    return;
                }

                if (bEditText.getText().toString().equals("")) {
                    Toast errorToast = Toast.makeText(MainActivity.this, "Error, please write the value of b parameter", Toast.LENGTH_SHORT);
                    errorToast.show();
                    return;
                }

                if (cEditText.getText().toString().equals("")) {
                    Toast errorToast = Toast.makeText(MainActivity.this, "Error, please write the value of c parameter", Toast.LENGTH_SHORT);
                    errorToast.show();
                    return;
                }
